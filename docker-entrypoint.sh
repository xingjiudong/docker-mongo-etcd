...
mkdir -p /etc/keyfile
etcdctl --endpoints http://${ETCD_CLIENT_IP:-127.0.0.1}:2379 get ${CLUSTER_PATH:-/mongo-config}/mongodb-keyfile > /etc/keyfile/mongodb-keyfile
chmod 600 /etc/keyfile/mongodb-keyfile
chown 999 /etc/keyfile/mongodb-keyfile
